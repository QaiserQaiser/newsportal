...
def WEBSITE_UPDATE(request):
    ...
    if not Page.objects.exists():
        Page.objects.create(
            pagetitle="My News Portal",
            address="123 News Street, City, Country",
            aboutus="Welcome to our news portal. We provide the latest news and updates.",
    ...
    # Get the first page (there should always be at least one now)
